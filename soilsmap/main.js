...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.addEventStart = function (type, event) {
        var testDate = (event.value.getMonth() + 1) + ' ' + event.value.getDate() + ', ' + event.value.getFullYear();
