...
function toggleMarkers() {
    var markercheckBox = document.getElementById("markercbox");
...
function createMarkers() {
    ...
    for (var i = 0; i < allIssues.length; i++) {
        ...
        if (allIssues[i].issue == 'Tensions') {
            ...
            var marker = L.circleMarker(new L.LatLng(allIssues[i].lat, allIssues[i].lng), markerOptions);
            marker.bindPopup(popuphtml);
            violenceMarkerGroup.addLayer(marker);
...
function switchlayer(layer) {
    ...
    document.getElementById('show').classList.remove('disabledButton');
    document.getElementById('dontshow').classList.remove('disabledButton');
    if (document.getElementById('dontshow').classList.contains('frombrg')) {
        dohButtonSelected(document.getElementById('dontshow'));
    }
    ...
    if (layer == 'locnone') {
        ...
        document.getElementById('dontshow').classList.remove('frombrg');
        ...
        document.getElementById('show').classList.remove('selected');
        document.getElementById('show').classList.add('disabledButton');
        document.getElementById('dontshow').classList.add('disabledButton');
        document.getElementById('dontshow').classList.add('frombrg');
...
function dohButtonSelected(t) {
    if (!document.getElementById('locbrg').classList.contains('selected')) {
